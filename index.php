...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Raleway:100,200,300,300i,400" rel="stylesheet">
...
<body>
    ...
    <section class="section-features js--section-features" id="features">
        <div class="row">
            ...
            <p class="long-copy">
                Hello, we're Omnifood, your new premium food delivery service. We know you're already busy. No time for cooking. So let us take care of that, we're really good at it, we promise!
            </p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-3">
                <blockquote>Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                    <cite><img src="resources/css/img/customer-2.jpg" alt="customer 2 photo">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBPM2kUL6XNQgkw4qWpitUqB_xpIxAUV-g"></script>
